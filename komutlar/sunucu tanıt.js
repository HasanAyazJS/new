...
exports.run = async (client, message, args) => {
    ...
    .addField(':warning: Uyarı :warning:', '`tr!sunucutanıt` adlı komutu özel mesajlarda kullanamazsın.')
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (https://discord.gg/AGQV3Ck).')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
  .addField('Sunucunu tanıtabilmek için beni ekle! https://is.gd/9aRpNM')
  .setColor('#00b6ff')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('631092177992286238').send(embed)
            });
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM**:sparkles:  \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! :flag_tr:  \n\n[MustafaKemalAtatürk | Destek Sunucusu](https://discord.gg/gsCQMDf) \n[Beni Sunucuna Ekleyebilmek İçin Tıklaman Yeterli!](https://is.gd/9aRpNM)'
            }});
  }
};
